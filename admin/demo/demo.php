...
$tab1 = [
        ...
        'fields' => [
            ...
            'data'        => 'post_types',
                ...
                'required' => [['v-switch-posts'], ['v_custom_text']],
                ...
                'id'       => 'v_delete_number',
                'type'     => 'number',
                'required' => [['v-switch-posts'], ['v_enable_delete']],
                ...
                'type'     => 'number',
                'required' => [['v-switch-posts'], ['v_enable_delete'], ['v_enable_deletesdsd']],
                'title'    => __('Number of dislikes:', $domain),
                'subtitle' => __('Auto delete post at a given number of dislikes', $domain),
                'default'  => '10',
            ], [
...
Sse::setSection($opt_name, $tab1);
        ...
        'fields' => [
            ...
            'data'        => 'post_types',
                ...
                'required' => [['v-switch-comments'], ['v_custom_text_com']],
                'title'    => __('Custom text for like', $domain),
                'default'  => 'Thank you for voting',
            ], [
...
$documentation = [
        ...
        'id'     => 'documentation',
        'fields' => [], //empty fields array must be present if not error
